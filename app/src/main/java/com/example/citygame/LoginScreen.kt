        ...
        Surface () {
            Box(contentAlignment = Alignment.Center) {
                ...
                Column(
                    ...
                    Text(text = "Welcome to the TheQuest", fontSize = 30.sp, color = Color.White, textAlign = TextAlign.Center)
                    ...
                    ClickableText( style = TextStyle(color = Color.White),
